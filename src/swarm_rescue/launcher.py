...
class Launcher:
    ...
    def __init__(self):
        ...
        eval_config = EvalConfig(map_type=MyMapIntermediate01, zones_config=zones_config, nb_rounds=1, config_weight=1)
        ...
        #eval_config = EvalConfig(map_type=MyMapIntermediate02_2023, nb_rounds=1)
        #self.eval_plan.add(eval_config=eval_config)
